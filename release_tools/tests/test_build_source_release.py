...
class SourceReleaseTests(unittest.TestCase):
    ...
    def test_archive_still_rejects_undocumented_fonts_next_to_the_licensed_ones(self) -> None:
        ...
        for name in (
            "software/study_runner/apps/ui/vendor/unlicensed/Other-Regular.woff2",
            "software/study_runner/apps/ui/styles/Smuggled-Regular.ttf",
            "software/study_runner/apps/ui/fonts/nested/Deeper-Regular.otf",
        ):
    ...
    def test_archive_carries_both_licensed_font_families(self) -> None:
        ...
        with temporary_directory() as temporary:
            ...
            write_zip(path, members(
                "software/study_runner/apps/ui/fonts/Materiability-Regular.ttf",
                "software/study_runner/apps/ui/fonts/Materiability-SemiBold.ttf",
                "software/study_runner/apps/ui/fonts/Materiability-Bold.ttf",
                "software/study_runner/apps/ui/vendor/geist/Geist-Regular.woff2",
                "software/study_runner/apps/ui/vendor/geist/Geist-SemiBold.woff2",
                "software/study_runner/apps/ui/vendor/geist/Geist-Bold.woff2",
            ))
    ...
    def test_third_party_notices_require_native_patch_and_license_provenance(self) -> None:
        notice = (
            ...
            "Iconoir software/study_runner/apps/ui/vendor/iconoir/LICENSE. "
            "Geist software/study_runner/apps/ui/vendor/geist/LICENSE. The source archives "
        ...
        with self.assertRaisesRegex(release.ReleaseError, "required license text"):
            release.validate_third_party_license(
                "software/study_runner/apps/ui/vendor/iconoir/LICENSE", "MIT License"
            )
        with self.assertRaisesRegex(release.ReleaseError, "required license text"):
            release.validate_third_party_license(
                "software/study_runner/apps/ui/vendor/geist/LICENSE", "SIL OPEN FONT LICENSE Version 1.1"
            )
