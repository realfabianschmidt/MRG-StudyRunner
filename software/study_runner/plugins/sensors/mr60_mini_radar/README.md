...
3. Enable `MR60 Mini-radar` in the sensor dashboard.
...
```powershell
cd software
python study_runner\plugins\sensors\mr60_mini_radar\tools\ble_mr60_receiver.py
```
...
```powershell
python study_runner\plugins\sensors\mr60_mini_radar\tools\ble_mr60_receiver.py --scan-timeout 15
python study_runner\plugins\sensors\mr60_mini_radar\tools\ble_mr60_receiver.py --address "<BLE address or identifier>"
python study_runner\plugins\sensors\mr60_mini_radar\tools\ble_mr60_receiver.py --csv mr60_debug.csv
python study_runner\plugins\sensors\mr60_mini_radar\tools\ble_mr60_receiver.py --osc-port 8000
```
