...
present and large enough, it is copied into the DeepFace cache at
`~/.deepface/weights/facial_expression_model_weights.h5`. If the file is not
present, the repair action falls back to the official DeepFace model download.
