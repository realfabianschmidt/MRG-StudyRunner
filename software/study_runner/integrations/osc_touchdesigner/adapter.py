...
Configure the target host, port, and message addresses in study_content/settings/hardware_settings.json:
  {
    "osc": {
      "enabled": true,
      "host": "127.0.0.1",
...
Enable:   set "osc": { "enabled": true } in study_content/settings/hardware_settings.json
"""
