...
DEFAULT_WORKER = {
    "script_path": "study_runner/integrations/camera_emotion/worker/server.py",
    "log_dir": "study_runner/integrations/camera_emotion/worker/logs",
    "model_assets_dir": "study_runner/integrations/camera_emotion/worker/model_assets",
    "deepface_home": "study_runner/integrations/camera_emotion/worker/deepface_home",
}
