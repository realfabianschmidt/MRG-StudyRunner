...
class SourceInstallScriptTests(unittest.TestCase):
    ...
    def test_macos_intel_keeps_local_tensorflow_out_of_the_base_install(self) -> None:
        ...
        for relative_path in (
            "software/requirements.txt",
            "software/study_runner/extensions/sensors/camera_emotion/worker/requirements.txt",
        ):
    ...
    def test_separately_licensed_model_is_not_a_silent_release_dependency(self) -> None:
        ...
        manifest = text("software/study_runner/extensions/sensors/camera_emotion/manifest.json")
        worker = text("software/study_runner/extensions/sensors/camera_emotion/worker/plugin.py")
