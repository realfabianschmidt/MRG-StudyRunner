...
from study_runner.data_core.host.sensor_flush_service import (
    SensorFlushService,
...
class SensorFlushServiceTests(unittest.TestCase):
    def test_flush_once_writes_one_file_per_exported_sensor(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("study_runner.data_core.host.sensor_flush_service.export_interval_sidecars", return_value=FAKE_EXPORT):
