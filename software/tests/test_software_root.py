...
class SoftwareRootTests(unittest.TestCase):
    ...
    def test_no_module_counts_parents_to_reach_the_software_root(self) -> None:
        ...
        watched = [
            ...
            PROJECT_ROOT / "study_runner" / "plugins" / "sensors" / "camera_emotion" / "worker" / "plugin.py",
            PROJECT_ROOT / "study_runner" / "plugins" / "sensors" / "mr60_mini_radar" / "tools" / "ble_mr60_receiver.py",
        ]
