// Example question-card browser module -- Study Runner extension SDK template.
//
...
// This file is a browser (ES module) asset: tools/extension_sdk.py's
...
export function renderStudy(q, i) {
  return `
    ...
    <textarea id="q${i}" class="fi-textarea"></textarea>`;
}
