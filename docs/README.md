...
- `../software/study_runner/plugins/sensors/brainbit/README.md` (plus
...
- `../software/study_runner/plugins/sensors/camera_emotion/README.md`: camera capture,
  DeepFace worker modes, setup, and repair.
- `../software/study_runner/plugins/sensors/mr60_mini_radar/README.md` (plus
  `firmware/README.md`): BLE setup and the firmware/packet layout.
- `../software/study_runner/plugins/destinations/nextcloud_upload/README.md`: the
  hand-written WebDAV client and its share-link settings.
- `../software/study_runner/plugins/destinations/notion_upload/README.md`: the
  `notion-client` integration and its settings.
- `../software/study_runner/plugins/outputs/osc_touchdesigner/README.md`: OSC
