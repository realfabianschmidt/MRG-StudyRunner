...
`software/study_runner/apps/ui/vendor/iconoir/iconoir.css` contains Iconoir 7.11.1
...
`software/study_runner/apps/ui/vendor/geist/` contains three weights each of Geist
...
`software/study_runner/plugins/sensors/brainbit/HelloEEG_HelloMYO_01.3.toe` is a
